 ...
 * @author pwann
 */
public class FindProductForm extends javax.swing.JFrame {
    ...
    //MainForm mf;
    JFrame mf;
    private ProductListTableModel model;

    Product Prod = new Product();

    public FindProductForm(JFrame mf) {
        this.mf = mf;
    ...
    private void btnFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFindActionPerformed
        ...
        if (prodList.isEmpty()) {
            ...
            if (mf instanceof MainForm) {
                ...
                _mf.setTableByFinding(new ProductListTableModel());
        ...
        model = new ProductListTableModel();
        pro = prodList.get(0);
        ...
        model.addAllData(productListToSet);
        if (mf instanceof MainForm) {
            MainForm _mf = (MainForm) this.mf;
            _mf.setTableByFinding(model);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FindProductForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FindProductForm(null).setVisible(true);
            }
        });
    }
