 ...
 * @author pwann
 */
public class GroupTypeAdd extends javax.swing.JFrame {

    /**
     * Creates new form GroupTypeAdd
     */
    ...
    public GroupTypeAdd() {
        ...
        conn.connect();
        maxID = conn.QueryPartTypeMaxIndex();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("เพิ่มหมวดหมู่");

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 153, 0));
        jLabel2.setText("ชื่อหมวด:");

        tfGroupName.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        if (tfGroupName.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "กรุณาใส่ชื่อหมวด");
            return;
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GroupTypeAdd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GroupTypeAdd().setVisible(true);
            }
        });
    }
