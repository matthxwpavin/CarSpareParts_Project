 ...
 * @author pwann
 */
public class SellInvoiceTableModel extends AbstractTableModel {

    private int maxRowIndex = -1;
    private int numRow = 2000;
    private int numCol = 6;
    private String[] columnNames = {"รหัสสินค้า", "ชื่อสินค้า", "จำนวน","ราคาขาย/หน่วย","รวม"};
    private Object[][] data = new Object[numRow][numCol];
    private ArrayList<Product> dataList;

    public SellInvoiceTableModel() {
    ...
    public void addAllData(ArrayList<Product> obj) {
        ...
        for (Product p : dataList) {
            ...
            setValueAt(p.getPrice(), row, 3);
            setValueAt(p.getAmount(), row, 4);
